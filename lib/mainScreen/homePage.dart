                      ...
                      child: Padding(
                        ...
                        child: ListTile(
                          leading: CustomCheckBox(
                            ...
                            value:snapshot.hasData&&snapshot.data!.exists && snapshot.data!.data()!.isNotEmpty && (snapshot.data!.data()!["Checker"][index])==true?true:false,
                          ...
                          title: Text(
                            snapshot.hasData&&snapshot.data!.exists && snapshot.data!.data()!.isNotEmpty?snapshot.data!.data()!["Task List"][index]:"",
                            style: TextStyle(
                                color: snapshot.hasData&&snapshot.data!.exists && snapshot.data!.data()!.isNotEmpty && (snapshot.data!.data()!["Checker"][index])==true?
                                    Colors.white38
                                    : Colors.white,
                                decoration: snapshot.hasData&&snapshot.data!.exists && snapshot.data!.data()!.isNotEmpty && (snapshot.data!.data()!["Checker"][index])==true
